...
parser.add_argument("--data_dir", default="/data/dataset/djTestData")
...
def main():
    ...
    model.fit(ds, epochs=args.num_epochs, steps_per_epoch=steps_per_epoch)
    if args.rank == 0:
        manager.save()
        # model.save(args.train_dir, save_format='tf')
    print("==========train end============")
